    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->pages([
                ...
                \App\Filament\Petugas\Pages\Kasir::class,
                \App\Filament\Admin\Pages\MonitoringStok::class,
            ])
            ...
            ->plugins([
                ...
                \DiogoGPinto\AuthUIEnhancer\AuthUIEnhancerPlugin::make()
                    ...
                    ->emptyPanelBackgroundImageUrl('https://images.unsplash.com/photo-1550572017-edd951b55104?q=80&w=1200&auto=format&fit=crop'),
            ])
            ->middleware([
