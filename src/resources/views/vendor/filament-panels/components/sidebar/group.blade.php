        ...
        >
            ...
            @if ($collapsible)
                <x-filament::icon-button
                    ...
                    x-bind:style="$store.sidebar.groupIsCollapsed(label)
                        ? 'transform: rotate(180deg); transition: transform 0.35s cubic-bezier(0.4,0,0.2,1);'
                        : 'transform: rotate(0deg); transition: transform 0.35s cubic-bezier(0.4,0,0.2,1);'"
                />
            @endif
        </div>
    @endif
